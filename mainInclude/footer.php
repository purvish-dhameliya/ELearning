 ...
 <footer class="container-fluid bg-dark text-center p-2">
    <small class="text-white">Copyright &copy; 2023 || E-Learning || <?php   
          if (isset($_SESSION['is_admin_login'])){
            echo '<a href="admin/adminDashboard.php"> Admin </a> <a href="logout.php">Logout</a>';
          }else {
            echo '<a href="#login" data-toggle="modal" data-target="#adminLoginModalCenter" class="login_btn"> Admin Login</a>';
          }
    ?>
  </small> 
